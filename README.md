<!DOCTYPE html>
<html>
<title>Brainy Backpack</title>

<xmp theme="sketchy" style="display:none;">
# Overview
...
In building the project, I came to realize that anteaters would be amazing pets.  Data was collected and summarized below (example of externally hosted video embedded):
